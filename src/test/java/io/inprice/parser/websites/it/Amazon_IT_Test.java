...
public class Amazon_IT_Test {
	...
	private final Website site = new AmazonIT();
	...
	public void test_product_1() {
		...
		assertEquals(
		    "KollyKolla Bottiglia Acqua in Acciaio Inox - 350/500/650/750ml, Senza BPA, Borraccia Termica Isolamento Sottovuoto a Doppia Parete, Borracce per Bambini, Scuola, Sport, All'aperto, Palestra, Yoga",
		    link.getName());
	...
	public void test_product_2() {
		...
		assertEquals("Nessun venditore spedisce attualmente questo prodotto in Turchia. Maggiori informazioni",
		    link.getShipment());
		assertTrue(link.getSpecList().size() > 0);
	}
	...
	public void test_product_3() {
		...
		assertEquals(
		    "FOREO LUNA play dispositivo per la pulizia del viso sonico Aquamarine , ultra portatile ed impermeabile",
		    link.getName());
	...
	public void test_product_4() {
		...
		assertEquals(
		    "Cuffie Bluetooth Paww Wavesound 3 con Cancellazione del Rumore Adattiva, adattatore per aereo, cavo di ricarica e custodia",
		    link.getName());
