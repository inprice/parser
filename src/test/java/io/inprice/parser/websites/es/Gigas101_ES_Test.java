...
public class Gigas101_ES_Test {
	...
	public void test_product_1() {
		...
		assertEquals(
		    "MANDO INALÁMBRICO DUALSHOCK 4 SONY CUH-ZCT2E WAVE BLUE - VALIDO PARA PS4 - CONECTOR AURICULAR - ALTAVOZ INTEGRADO - PANEL TÁCTIL",
		    link.getName());
	...
	public void test_product_3() {
		...
		assertEquals(
		    "Western Digital WD Black SN750 NVMe SSD WDS100T3XHC - Unidad en estado sólido - 1 TB - interno - M.2 2280 - PCI Expr",
		    link.getName());
