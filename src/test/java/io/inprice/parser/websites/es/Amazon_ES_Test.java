...
public class Amazon_ES_Test {
	...
	private final Website site = new AmazonES();
	...
	public void test_product_1() {
		...
		assertEquals(
		    "Xiaomi Mi Band 3 Pulsera de Actividad Inteligente Rastreador Deportes Deportiva con Pulsómetro Monitor de Ritmo Cardíaco 0,78 Pulgadas OLED Pantalla Táctil Pronóstico del Tiempo Negro",
		    link.getName());
	...
	public void test_product_3() {
		...
		assertEquals(
		    "Travis Touch - Traductor Inteligente de Bolsillo a 105 Idiomas Con Pantalla Táctil, 4G LTE, Hotspot y Carga Inalámbrica",
		    link.getName());
