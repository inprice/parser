...
public class Amazon_CA_Test {
	...
	private final Website site = new AmazonCA();
	...
	public void test_product_3() {
		...
		assertEquals("South Shore Furniture Cuddly Changing Table with Removable Changing Station, Pure White",
		    link.getName());
	...
	public void test_product_4() {
		...
		assertEquals("Lifelike Toys for Women - Large Size - 36 Speeds - USB Rechargeable - Perfect Size & Party Gifts",
		    link.getName());
