...
public class Amazon_UK_Test {
	...
	private final Website site = new AmazonUK();
	...
	public void test_product_1() {
		...
		assertEquals("Waterpik WP-560UK Cordless Advanced Water Flosser - White Edition (UK 2-Pin Bathroom Plug)",
		    link.getName());
	...
	public void test_product_4() {
		...
		assertEquals(
		    "OMERIL LED Head Torch, [2 Pack] Super Bright Headlamps with 3 Modes, 150 Lumens, Lightweight COB Head Lights for Kids Running Walking Camping Fishing, Car Repair, DIY- 6*Batteries Included",
		    link.getName());
	...
	public void test_product_5() {
		...
		assertEquals(
		    "NULAXY [Upgraded Version Phone Stand, Adjustable Mobile Phone Desk Holder, Cradle, Dock, Cell Phone Stand compatible with iPhone Xs Xr 8 X 7 6 6s Plus SE 5 5s 5c, All Smartphones-Black",
		    link.getName());
