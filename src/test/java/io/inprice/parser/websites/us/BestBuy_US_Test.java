...
public class BestBuy_US_Test {
	...
	public void test_product_2() {
		...
		assertEquals("Sony - WH-1000XM3 Wireless Noise Canceling Over-the-Ear Headphones with Google Assistant - Black",
		    link.getName());
	...
	public void test_product_3() {
		...
		assertEquals(
		    "CyberPowerPC - Gaming Desktop - AMD Ryzen 7 2700 - 16GB Memory - AMD RX 580 8GB - 2TB Hard Drive + 240GB Solid State Drive - White",
		    link.getName());
