...
public class Etsy_US_Test {
	...
	public void test_product_1() {
		...
		assertEquals("Wood wall Art, orange white art, reclaimed, 3D wood mosaic, modern wood art, abstract painting",
		    link.getName());
	...
	public void test_product_2() {
		...
		assertEquals(
		    "Purple pencil dress, Cocktail Stand collar Cheongsam Dress, Office Keyhole Fitted Wiggle Asian dress, Chinese Mandarin Dress TAVROVSKA",
		    link.getName());
	...
	public void test_product_3() {
		...
		assertEquals(
		    "Mint to Be Wedding Favor Stickers - 12 personalized favor labels, Tic Tac box stickers for mint favors, wedding or bridal shower gifts",
		    link.getName());
		assertEquals("7.00", link.getPrice().toString());
		assertEquals("Brittany", link.getBrand());
		assertEquals("crakd", link.getSeller());
		assertEquals("Ready to ship in 2 business days. From United States. USD 14.35 shipping to Turkey.",
		    link.getShipment());
		assertTrue(link.getSpecList().size() > 0);
	}
	...
	public void test_product_4() {
		...
		assertEquals("Ready to ship in 3–5 business days. From United States. USD 18.90 shipping to Turkey.",
		    link.getShipment());
		assertTrue(link.getSpecList().size() > 0);
	}
