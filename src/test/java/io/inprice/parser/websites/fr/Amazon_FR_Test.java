...
public class Amazon_FR_Test {
	...
	private final Website site = new AmazonFR();
	...
	public void test_product_1() {
		...
		assertEquals("Igloohome| Smart KeyBox 2 | Boîte à Clé Sécurisée Intelligente | PIN et Bluetooth | Noir",
		    link.getName());
	...
	public void test_product_3() {
		...
		assertEquals(
		    "DIDAR Projecteur 3500 Lumens Vidéoprojecteur Soutien HD1080P Portable Retroprojecteur, Multimédia Home Cinéma Full HD Pordinateur, Compatible avec HDMI VGA AV SD USB, Home Théâtre Projecteur",
		    link.getName());
